...
# This file is reproduced with some modifications from:
#
# https://github.com/aws/aws-cli
#
# List of modifications:
# 1) Exceptions changed to use ones in local module (to avoid imports from awscli)
# 2) Replace stdio with print
#
# Original copyright belongs to Amazon.com
#
# Developer notes:
# This file contains some very useful utility functions that enable easier
# deployments using cloudformation that do not exist in boto3 but rather the
# AWS CLI.
# Expect this code to deprecate over time as the AWS CLI is updated, or the boto3
# library gains new functionality.
#
import collections
import logging
import time
...
class Deployer(object):
    ...
    def wait_for_changeset(self, changeset_id, stack_name):
        ...
        try:
            ...
            if status == "FAILED" and \
                ...
                raise errors.ChangeEmptyError(stack_name=stack_name)
    ...
    def wait_for_execute(self, stack_name, changeset_type):
        ...
        print("Waiting for stack create/update to complete\n")
        ...
        try:
            ...
            raise errors.DeployFailedError(stack_name=stack_name)
